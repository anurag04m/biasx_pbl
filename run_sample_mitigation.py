...
metrics = det.calculate_metrics(['statistical_parity_difference','disparate_impact','base_rate'])
...
try:
    ...
    metrics_rw = det_rw.calculate_metrics(['statistical_parity_difference','disparate_impact','base_rate'])
...
try:
    ...
    metrics_dir = det_dir.calculate_metrics(['statistical_parity_difference','disparate_impact','base_rate'])
...
try:
    ...
    metrics_opt = det_opt.calculate_metrics(['statistical_parity_difference','disparate_impact','base_rate'])
